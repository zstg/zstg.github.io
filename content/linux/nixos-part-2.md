...
I'd last used NixOS back [in 2023](http://zstg.is-a.dev/linux/nixos-part-1/).
## Why did i move from Arch?

I had been using Arch Linux for a while and, while I was comfortable with it, I felt the urge for a change. Arch served me well, but I wanted to give it a try again - without losing any data. Thankfully, I retained my home partition, so I could make the transition to NixOS without any risk of losing my files. Everything stayed intact.
...
![NixOS config - tree-like structure](/linux/nixos-tree.png)
